...
export default function ChangeLog() {
  ...
  const searchedTableRows = buildAndSortTableRows(
    searchedData?.results,
  );

  if (loading) return <LoadingScreen />;
  if (searchedData?.statusCode === 403)
    return <SadScreen statusCode={searchedData?.statusCode} />;
  ...
  return (
    <MainColumn>
      ...
      <Grid item>
        ...
        >
          <Text variant="h5" component="h5" id="CHANGE_LOG" />
        ...
        <DataDisplay
          style={{ marginTop: 8 }}
          noTitleBar
          cellStyles={{ overflow: 'wrap', maxWidth: 500 }}
          variant="secondary"
