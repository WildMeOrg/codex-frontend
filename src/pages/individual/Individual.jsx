...
export default function Individual() {
  ...
  const [firstName, adoptionName, autogenName] = useMemo(
    () => [
      deriveIndividualName(
        individualData,
        'FirstName',
      ...
      individualData?.names.find(name => name.autogeneratedName)?.value || '-',
    ],
    [intl, individualData],
  );
  ...
  return (
    <MainColumn fullWidth>
      ...
      <EntityHeader
        name={firstName}
        codexID={`${intl.formatMessage({ id: 'CODEX_ID'})}\u00A0:\u00A0\u00A0\u00A0 ${autogenName}`}
        renderAvatar={
          <FeaturedPhoto
